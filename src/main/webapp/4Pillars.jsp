    ...
    <div class="accordion-item">
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <strong>Abstraction is Hiding functionality of methods from the user.</strong> Users don't need to know how methods work, they should simply be able to call the method when they need to.<code>.accordion-body</code>, though the transition does limit overflow.
            </div>
        </div>
    </div>
